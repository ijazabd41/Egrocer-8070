...
async function main() {
  ...
  try {
    ...
    console.log("Auth Response Result:", authRes.data.result);
    ...
    console.log("Updating order with amount_discount...");
    ...
    // Fetch order
    const ord = await getJson(`/api/order/${orderId}`, {}, sessionId);
    console.log("Order totals after discount update:", JSON.stringify(ord.data[0], ['id', 'name', 'amount_untaxed', 'amount_tax', 'amount_total', 'amount_discount', 'carrier_id'], 2));
